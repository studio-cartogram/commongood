<?php
	...
	/**
	 * Add wrapping div to inserted images
	 *
	 */
	function landing_imagewrap_send_to_editor($html, $id, $caption, $title, $align, $url, $size, $alt){
	   return '<div class="post__img--' . $size . '">'.$html.'</div>';
	}
?>
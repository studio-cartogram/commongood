...
module.exports = function (grunt) {
	...
	yeoman: {
		// configurable paths
		app: require('./bower.json').appPath || 'app/themes/commongood',
		dist: 'app/themes/commongood/dist'
	},
	...
	ngmin: {
		dist: {
			controllers: {
				...
				dest: '<%= yeoman.app %>/scripts/controllers/generated/*.js'
			}
		}
	},
	...
	uglify: {
		dist: {
			...
			files: {
				'<%= yeoman.dist %>/scripts/cartogram.min.js': [
					'<%= yeoman.dist %>/scripts/cartogram.js'
				]
			}
		}
	},
	concat: {
		...
		dist: {
			...
			dest: '<%= yeoman.dist %>/scripts/cartogram.js',
		},
	},
